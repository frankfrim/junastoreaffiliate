var Snake = (function () {
  ...
  var game = {
    ...
    loop: function () {
      ...
      ctx.fillRect(fruit.x * gridSize+0.1, fruit.y * gridSize+1, gridSize-0.2, gridSize-0.2);

      if(stopped) {
        ctx.fillStyle = '#7f98ffa9';
        ctx.font = "small-caps bold 14px Helvetica";
        ctx.fillText("press ARROW KEYS to START Falcon Apps Com....", 24, 374);
      }
